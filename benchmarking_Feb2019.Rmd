...
for(mymean in c(.6)){ # mean benchmark level; probability that a student passes 
    ...
    mymat <- data.frame(matrix(rbinom(nuni*ncontext,unlist(myNmat),mymean),nrow=nuni))/myNmat
